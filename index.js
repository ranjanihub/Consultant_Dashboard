...
var require_main = __commonJS({
  "../../node_modules/.pnpm/dotenv@17.4.2/node_modules/dotenv/lib/main.js"(exports, module) {
    ...
    function dim(text11) {
      return supportsAnsi() ? `\x1B[2m${text11}\x1B[0m` : text11;
    }
...
router13.use(sessions_default);
router13.use(calendar_default);
router13.use(outcomes_default);
router13.use(revenue_default);
router13.use(reviews_default);
router13.use(blog_default);
router13.use(profile_default);
router13.use(htmlChunks_default);
