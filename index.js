...
var GetDashboardStatsResponse = objectType({
  ...
  "sessionsRemaining": numberType(),
  "activeClients": numberType(),
  "newClientsThisWeek": numberType(),
  "pendingReports": numberType(),
  "homeworkToReview": numberType(),
  "homeworkDueToday": numberType(),
  "therapyHoursThisWeek": numberType(),
  "improvementAverage": numberType(),
  "totalClientsCount": numberType(),
  "therapistName": stringType(),
  "therapistTitle": stringType(),
  "isAvailable": booleanType(),
  "therapyHoursToday": stringType()
});
var GetUpcomingSessionsResponseItem = objectType({
  "id": numberType(),
  "clientName": stringType(),
  "clientInitials": stringType(),
  "sessionType": stringType(),
  "sessionSubtype": stringType().optional(),
  "startTime": stringType(),
  "endTime": stringType(),
  "durationMinutes": numberType(),
  "countdownLabel": stringType(),
  "sessionNumber": numberType(),
  "isNext": booleanType()
});
var GetUpcomingSessionsResponse = arrayType(GetUpcomingSessionsResponseItem);
var GetPendingReportsResponseItem = objectType({
  "sessionId": numberType(),
  "clientName": stringType(),
  "clientInitials": stringType(),
  "sessionDate": stringType(),
  "sessionTime": stringType(),
  "sessionType": stringType(),
  "sessionNumber": numberType()
});
var GetPendingReportsResponse = arrayType(GetPendingReportsResponseItem);
var GetWeeklyScheduleResponseItem = objectType({
  "day": stringType(),
  "booked": numberType(),
  "completed": numberType(),
  "available": numberType()
});
var GetWeeklyScheduleResponse = arrayType(GetWeeklyScheduleResponseItem);
var GetRecentActivityResponseItem = objectType({
  "id": numberType(),
  "clientName": stringType(),
  "clientInitials": stringType(),
  "activityType": enumType(["homework_completed", "assessment_completed", "mood_checkin", "journal_shared", "message_received"]),
  "description": stringType(),
  "timeAgo": stringType()
});
var GetRecentActivityResponse = arrayType(GetRecentActivityResponseItem);
var GetClientImprovementSummaryResponse = objectType({
  "score": numberType(),
  "changePercent": numberType(),
  "changeDirection": enumType(["up", "down", "stable"]),
  "trend": arrayType(objectType({
    "month": stringType(),
    "score": numberType()
  }))
});
var GetClientsQueryParams = objectType({
  "status": enumType(["active", "completed", "inactive", "high_priority", "new"]).optional(),
  "search": coerce.string().optional()
});
var GetClientsResponseItem = objectType({
  "id": numberType(),
  "name": stringType(),
  "initials": stringType(),
  "age": numberType(),
  "gender": stringType(),
  "status": enumType(["active", "completed", "inactive", "high_priority", "new"]),
  "primaryGoal": stringType(),
  "lastSession": stringType().nullish(),
  "nextSession": stringType().nullish(),
  "progressPercent": numberType()
});
var GetClientsResponse = arrayType(GetClientsResponseItem);
var GetClientParams = objectType({
  "id": coerce.number()
});
var GetClientResponse = objectType({
  "id": numberType(),
  "name": stringType(),
  "initials": stringType(),
  "age": numberType(),
  ...
  "status": stringType(),
  "primaryGoal": stringType(),
  "presentingProblems": arrayType(stringType()),
  "identifiedConcerns": arrayType(stringType()),
  "therapyGoals": arrayType(stringType()),
  "preferredLanguage": stringType(),
  "communicationPreference": stringType(),
  "therapyTimeline": stringType(),
  "aiIntakeSummary": stringType(),
  "sessionCount": numberType(),
  "startDate": stringType()
});
var GetClientAssessmentsParams = objectType({
  "id": coerce.number()
});
var GetClientAssessmentsResponseItem = objectType({
  "id": numberType(),
  "type": enumType(["PHQ-9", "GAD-7", "PANAS", "other"]),
  "name": stringType(),
  "currentScore": numberType(),
  "maxScore": numberType(),
  "previousScore": numberType().nullish(),
  "severity": stringType(),
  "completedAt": stringType(),
  "trend": arrayType(objectType({
    "date": stringType(),
    "score": numberType()
  }))
});
var GetClientAssessmentsResponse = arrayType(GetClientAssessmentsResponseItem);
var GetClientMoodParams = objectType({
  "id": coerce.number()
});
var GetClientMoodResponse = objectType({
  "today": numberType().nullish(),
  "weeklyTrend": arrayType(objectType({
    "date": stringType(),
    "mood": numberType(),
    "note": stringType().nullish()
  }))
});
var GetClientHomeworkParams = objectType({
  "id": coerce.number()
});
var GetClientHomeworkResponseItem = objectType({
  "id": numberType(),
  "activity": stringType(),
  "instructions": stringType(),
  "frequency": stringType(),
  "dueDate": stringType(),
  "status": enumType(["completed", "pending", "missed"]),
  "completionPercent": numberType(),
  "streak": numberType(),
  "clientReflection": stringType().nullish()
});
var GetClientHomeworkResponse = arrayType(GetClientHomeworkResponseItem);
var GetClientSessionHistoryParams = objectType({
  "id": coerce.number()
});
var GetClientSessionHistoryResponseItem = objectType({
  "id": numberType(),
  "date": stringType(),
  "durationMinutes": numberType(),
  "sessionType": stringType(),
  "summary": stringType(),
  "homeworkAssigned": stringType().nullish(),
  "therapistNotes": stringType().nullish()
});
var GetClientSessionHistoryResponse = arrayType(GetClientSessionHistoryResponseItem);
var SubmitSessionReportParams = objectType({
  "id": coerce.number()
});
var SubmitSessionReportBody = objectType({
  "durationMinutes": numberType(),
  "clientCooperation": enumType(["excellent", "good", "fair", "poor"]),
  "clientEngagementLevel": enumType(["high", "medium", "low"]),
  "moodComparedToPrevious": enumType(["much_better", "better", "same", "worse", "much_worse"]),
  "progressTowardsGoals": enumType(["significant", "moderate", "minimal", "none"]),
  "techniquesUsed": arrayType(stringType()),
  "topicsDiscussed": arrayType(stringType()),
  "riskFlags": stringType().nullish(),
  "clinicalSummary": stringType(),
  "internalNotes": stringType().nullish(),
  "homeworkActivity": stringType().nullish(),
  "homeworkInstructions": stringType().nullish(),
  "homeworkFrequency": stringType().nullish(),
  "nextSessionRecommendation": enumType(["3_days", "1_week", "2_weeks", "1_month", "custom"]),
  "followUpMessage": stringType().nullish()
});
var SubmitSessionReportResponse = objectType({
  "id": numberType(),
  "sessionId": numberType(),
  "submittedAt": stringType(),
  "paymentEligible": booleanType()
});
var GetCalendarEventsQueryParams = objectType({
  "start": dateType().optional(),
  "end": dateType().optional(),
  "view": enumType(["day", "week", "month"]).optional()
});
var GetCalendarEventsResponseItem = objectType({
  "id": numberType(),
  "title": stringType(),
  "clientName": stringType().nullish(),
  "start": stringType(),
  "end": stringType(),
  "type": enumType(["session", "blocked", "holiday", "available"]),
  "sessionType": stringType().nullish(),
  "isRecurring": booleanType()
});
var GetCalendarEventsResponse = arrayType(GetCalendarEventsResponseItem);
var GetAvailabilityResponseItem = objectType({
  "id": numberType(),
...
var GetAvailabilityResponse = arrayType(GetAvailabilityResponseItem);
var SetAvailabilityBody = objectType({
  "dayOfWeek": stringType(),
  "startTime": stringType(),
  "endTime": stringType(),
  "isRecurring": booleanType()
});
var SetAvailabilityResponse = objectType({
  "id": numberType(),
  "dayOfWeek": stringType(),
  "startTime": stringType(),
  "endTime": stringType(),
...
var FetchClientOutcomesParams = objectType({
  "clientId": coerce.number()
});
var FetchClientOutcomesResponse = objectType({
  "clientId": numberType(),
  "clientName": stringType(),
  "improvementScore": numberType(),
  "goalAchievementRate": numberType(),
  "totalGoals": numberType(),
  "completedGoals": numberType(),
  "goalsInProgress": numberType(),
  "attendancePercent": numberType(),
  "sessionsAttended": numberType(),
  "missedSessions": numberType(),
  "rescheduledSessions": numberType(),
  "homeworkCompletionPercent": numberType(),
  "assignedActivities": numberType(),
  "completedActivities": numberType(),
  "currentStreak": numberType(),
  "engagementScore": numberType(),
  "engagementLevel": enumType(["high", "medium", "low"]),
  "assessmentTrends": arrayType(objectType({
    "name": stringType(),
...
var GetCaseloadOutcomesQueryParams = objectType({
  "period": enumType(["week", "month", "year", "custom"]).optional()
});
var GetCaseloadOutcomesResponse = objectType({
  "averageImprovementScore": numberType(),
  "averageGoalAchievementRate": numberType(),
  "averageAssessmentImprovement": numberType(),
  "overallAttendanceRate": numberType(),
  "averageHomeworkAdherence": numberType(),
  "averageEngagementScore": numberType(),
  "period": stringType(),
  "clientBreakdown": arrayType(objectType({
    "clientId": numberType(),
    "clientName": stringType(),
    "improvementScore": numberType(),
    "engagementScore": numberType(),
...
var GetRevenueSummaryQueryParams = objectType({
  "period": enumType(["week", "month", "year", "custom"]).optional()
});
var GetRevenueSummaryResponse = objectType({
  "totalRevenue": numberType(),
  "pendingPayments": numberType(),
  "completedConsultations": numberType(),
  "therapyHours": numberType(),
  "revenueChange": numberType(),
  "period": stringType()
});
var GetRevenueAnalyticsQueryParams = objectType({
  "period": enumType(["week", "month", "year", "custom"]).optional()
});
var GetRevenueAnalyticsResponseItem = objectType({
  "label": stringType(),
  "revenue": numberType(),
  "consultations": numberType(),
  "hours": numberType(),
  "avgPerConsultation": numberType()
});
var GetRevenueAnalyticsResponse = arrayType(GetRevenueAnalyticsResponseItem);
var GetTransactionsResponseItem = objectType({
  "id": numberType(),
  "date": stringType(),
  "clientName": stringType(),
  "amount": numberType(),
...
var GetTransactionsResponse = arrayType(GetTransactionsResponseItem);
var GetReviewsSummaryResponse = objectType({
  "averageRating": numberType(),
  "totalReviews": numberType(),
  "recommendationPercent": numberType(),
  "ratingTrend": arrayType(objectType({
    "month": stringType(),
    "rating": numberType(),
    "count": numberType()
  })),
  "ratingDistribution": arrayType(objectType({
    "stars": numberType(),
    "count": numberType()
  }))
});
var GetReviewsResponseItem = objectType({
  "id": numberType(),
  "rating": numberType(),
  "reviewText": stringType(),
  "date": stringType(),
  "therapistReply": stringType().nullish()
});
var GetReviewsResponse = arrayType(GetReviewsResponseItem);
var SubmitBlogPostBody = objectType({
  "title": stringType(),
  "featuredImage": stringType().nullish(),
  "category": stringType(),
  "tags": arrayType(stringType()).optional(),
  "content": stringType()
});
var SubmitBlogPostResponse = objectType({
  "id": numberType(),
  "title": stringType(),
  "category": stringType(),
  "tags": arrayType(stringType()),
  "content": stringType(),
  "status": enumType(["draft", "submitted", "published"]),
  "createdAt": stringType()
});
var GetBlogPostsResponseItem = objectType({
  "id": numberType(),
  "title": stringType(),
  "category": stringType(),
  "tags": arrayType(stringType()),
...
var GetBlogPostsResponse = arrayType(GetBlogPostsResponseItem);
var SubmitBlogOutlineBody = objectType({
  "proposedTitle": stringType(),
  "keyPoints": arrayType(stringType()),
  "targetAudience": stringType(),
  "keywords": arrayType(stringType()),
  "notes": stringType().nullish()
});
var SubmitBlogOutlineResponse = objectType({
  "id": numberType(),
  "proposedTitle": stringType(),
  "keyPoints": arrayType(stringType()),
  "targetAudience": stringType(),
...
var GetBlogOutlinesResponseItem = objectType({
  "id": numberType(),
  "proposedTitle": stringType(),
  "keyPoints": arrayType(stringType()),
  "targetAudience": stringType(),
...
var GetBlogOutlinesResponse = arrayType(GetBlogOutlinesResponseItem);
var GetProfileResponse = objectType({
  "id": numberType(),
  "name": stringType(),
  "title": stringType(),
  "bio": stringType(),
  "qualifications": arrayType(stringType()),
  "experience": numberType(),
  "languages": arrayType(stringType()),
  "specializations": arrayType(stringType()),
  "verificationStatus": enumType(["verified", "pending", "unverified"]),
  "consultationFee": numberType(),
  "workingDays": arrayType(stringType()),
  "consultationHours": stringType(),
  "isAvailable": booleanType(),
...
var UpdateProfileBody = objectType({
  ...
  "qualifications": arrayType(stringType()).optional(),
  "experience": numberType().optional(),
  "languages": arrayType(stringType()).optional(),
  "specializations": arrayType(stringType()).optional(),
  "consultationFee": numberType().optional(),
  "workingDays": arrayType(stringType()).optional(),
  "consultationHours": stringType().optional(),
...
var sessionTypeEnum = pgEnum("session_type", ["CBT", "ACT", "EMDR", "Intake", "Couples Therapy", "Follow-up", "DBT", "Mindfulness"]);
...
var sessionReportsTable = pgTable("session_reports", {
  id: serial("id").primaryKey(),
...
var assessmentsTable = pgTable("assessments", {
  id: serial("id").primaryKey(),
  clientId: integer("client_id").notNull().references(() => clientsTable.id),
...
var assessmentTrendsTable = pgTable("assessment_trends", {
  id: serial("id").primaryKey(),
  assessmentId: integer("assessment_id").notNull().references(() => assessmentsTable.id),
  date: text("date").notNull(),
  score: real("score").notNull()
});
var moodLogsTable = pgTable("mood_logs", {
  id: serial("id").primaryKey(),
  clientId: integer("client_id").notNull().references(() => clientsTable.id),
  date: text("date").notNull(),
...
var homeworkTable = pgTable("homework", {
  id: serial("id").primaryKey(),
  clientId: integer("client_id").notNull().references(() => clientsTable.id),
...
var activityLogsTable = pgTable("activity_logs", {
  id: serial("id").primaryKey(),
  clientId: integer("client_id").notNull().references(() => clientsTable.id),
...
var calendarEventsTable = pgTable("calendar_events", {
  id: serial("id").primaryKey(),
...
var availabilitySlotsTable = pgTable("availability_slots", {
  id: serial("id").primaryKey(),
...
var blogOutlinesTable = pgTable("blog_outlines", {
  id: serial("id").primaryKey(),
...
var therapistProfileTable = pgTable("therapist_profile", {
  id: serial("id").primaryKey(),
  name: text("name").notNull(),
  title: text("title").notNull(),
...
var Pool3 = esm_default.Pool || esm_default.default?.Pool;
...
router3.get("/clients/:id", async (req, res) => {
  ...
  const sessions = await db.select().from(sessionsTable).where(eq(sessionsTable.clientId, id));
  res.json({
    ...client,
...
router3.get("/clients/:id/assessments", async (req, res) => {
  const raw = Array.isArray(req.params.id) ? req.params.id[0] : req.params.id;
  const id = parseInt(raw, 10);
  const assessments = await db.select().from(assessmentsTable).where(eq(assessmentsTable.clientId, id));
  const result = await Promise.all(
    assessments.map(async (a) => {
      const trends = await db.select().from(assessmentTrendsTable).where(eq(assessmentTrendsTable.assessmentId, a.id));
...
router3.get("/clients/:id/mood", async (req, res) => {
  const raw = Array.isArray(req.params.id) ? req.params.id[0] : req.params.id;
  const id = parseInt(raw, 10);
  const logs = await db.select().from(moodLogsTable).where(eq(moodLogsTable.clientId, id));
  if (logs.length === 0) {
    res.json({
      today: 8,
      weeklyTrend: [
...
router3.get("/clients/:id/homework", async (req, res) => {
  const raw = Array.isArray(req.params.id) ? req.params.id[0] : req.params.id;
  const id = parseInt(raw, 10);
  const hw = await db.select().from(homeworkTable).where(eq(homeworkTable.clientId, id));
  if (hw.length === 0) {
    res.json([
      {
        id: 201,
...
router3.get("/clients/:id/session-history", async (req, res) => {
  const raw = Array.isArray(req.params.id) ? req.params.id[0] : req.params.id;
  const id = parseInt(raw, 10);
  const sessions = await db.select().from(sessionsTable).where(and(eq(sessionsTable.clientId, id), eq(sessionsTable.status, "completed")));
...
router4.post("/sessions/:id/report", async (req, res) => {
  ...
  await db.update(sessionsTable).set({ reportSubmitted: true }).where(eq(sessionsTable.id, sessionId));
  res.status(201).json({
    id: report.id,
...
router10.patch("/profile", async (req, res) => {
  ...
  const [updated] = await db.update(therapistProfileTable).set(updates).where(eq(therapistProfileTable.id, profile.id)).returning();
  res.json({
    id: updated.id,
    name: updated.name,
    title: updated.title,
