...
import { Bell, Lock, KeyRound, MonitorSmartphone, CreditCard, Shield, Settings as SettingsIcon } from "lucide-react";
  ...
  return (
    <div className="space-y-6 pb-10 max-w-5xl mx-auto">
      <PageHeader
        ...
        description="Configure notification preferences, payout settings, and active session devices."
        badge="PREFERENCES"
        icon={<SettingsIcon className="w-4 h-4 text-purple-200" />}
      />

      <div className="flex flex-col md:flex-row gap-6">
        <Tabs defaultValue="notifications" className="w-full flex flex-col md:flex-row gap-6">
