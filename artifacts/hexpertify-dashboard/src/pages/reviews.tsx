        ...
        <Card className="shadow-sm border-border bg-gradient-to-b from-amber-50/50 to-white">
          <CardContent className="p-8 flex flex-col items-center justify-center text-center">
            {summaryLoading ? (
              ...
              <>
                <div className="text-5xl font-black text-amber-500 mb-2">{(summary?.averageRating || 0).toFixed(1)}</div>
        ...
        <Card className="shadow-sm border-border">
          ...
          <CardContent>
            {summaryLoading ? (
              ...
              <div className="space-y-3 mt-2">
                {(Array.isArray(summary?.ratingDistribution) ? summary.ratingDistribution : []).map((dist) => (
            ...
            <div className="h-[140px] w-full mt-2">
              {summaryLoading ? (
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={Array.isArray(summary?.ratingTrend) ? summary.ratingTrend : []} margin={{ top: 0, right: 0, left: -20, bottom: 0 }}>
