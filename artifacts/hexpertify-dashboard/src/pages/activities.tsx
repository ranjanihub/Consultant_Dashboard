    ...
    try {
      await fetch('/api/activities/assign', {
        ...
        body: JSON.stringify({
          ...
          description: assignModalActivity.description,
          duration: assignModalActivity.duration,
          difficulty: assignModalActivity.difficulty,
          imageUrl: assignModalActivity.imageUrl,
          instructions: assignModalActivity.instructions,
          dueDate: assignModalActivity.dueDate,
